 ...
 * 
 */
@WebServiceClient(name = "CalculadoraImplService", targetNamespace = "http://ws/", wsdlLocation = "http://localhost:8085/ws/calculadora?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CALCULADORAIMPLSERVICE_QNAME = new QName("http://ws/", "CalculadoraImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8085/ws/calculadora?wsdl");
    ...
    public Calculadora getCalculadoraImplPort() {
        return super.getPort(new QName("http://ws/", "CalculadoraImplPort"), Calculadora.class);
    }
    ...
    public Calculadora getCalculadoraImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws/", "CalculadoraImplPort"), Calculadora.class, features);
    }
